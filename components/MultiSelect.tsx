  ...
  return (
    <div className={`relative space-y-1 ${className}`} ref={dropdownRef}>
      ...
      <div
        ...
        className="w-full min-h-[32px] pl-2 pr-6 py-1 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg text-xs cursor-pointer flex flex-wrap gap-1 items-center transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800"
      >
