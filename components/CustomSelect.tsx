    ...
    return (
        <div className={`relative space-y-1 ${className || ''}`} ref={dropdownRef}>
            ...
            <div 
                ...
                className="w-full min-h-[32px] pl-2 pr-8 py-1.5 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-md text-sm cursor-pointer flex items-center transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800 relative"
            >
            ...
            {isOpen && (
                <div className="absolute top-full left-0 w-full min-w-[150px] mt-1 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-md shadow-lg z-[60] max-h-60 overflow-y-auto p-1 animate-in fade-in zoom-in-95 duration-100">
                    {options.map((rawOpt) => {
