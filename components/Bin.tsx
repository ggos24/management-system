        ...
        <div className="flex items-center gap-3">
          ...
          {deletedTasks.length > 0 && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 border border-red-200 dark:border-red-800 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors"
            >
              <Trash2 size={12} />
              Empty Bin
            </button>
                ...
                >
                  ...
                  <td className="px-3 py-3">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs text-zinc-600 dark:text-zinc-400">{getMemberName(task.deletedBy)}</span>
                    </div>
                  </td>
                  <td className="px-3 py-3">
                    <div>
