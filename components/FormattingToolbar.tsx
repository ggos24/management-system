...
export const FormattingToolbar: React.FC<FormattingToolbarProps> = ({ onAction }) => (
  <div className="flex items-center gap-1 border-b border-zinc-200 dark:border-zinc-700 p-2 bg-zinc-50 dark:bg-zinc-800/50 rounded-t-lg">
    <button
      onClick={() => onAction('h2')}
      className="px-2 py-1.5 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-md text-zinc-600 dark:text-zinc-400 text-xs font-bold leading-[14px] -translate-y-[3px]"
      title="Heading 2"
    >
      H2
    </button>
    ...
    <button
      ...
      className="p-1.5 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-md text-zinc-600 dark:text-zinc-400 flex items-center gap-1"
      title="To-do List"
    >
      <CheckSquare size={14} />
    </button>
